                                    ...
                                    <div class="nk-block-head nk-block-head-lg">
                                        <div class="nk-block-between-md g-4">
                                            <div class="nk-block-head-content">
                                                <h2 class="nk-block-title fw-normal" style="text-align:center; marin-top:10%;">Su Pago fue realizado satisfactoriamente y su suscripcion se encuentra activa</h2>
                                            </div>
                                        </div>
