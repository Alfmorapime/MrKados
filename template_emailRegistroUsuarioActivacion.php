<html>
    <body>
        ...
        <div style="background:white; width:100%; color:black; font-weight:bold; text-align:center;">
            <p>
            Estás a un click de formar parte de nuestro mundo digital. Queremos empezar esta aventura contigo y que disfrutes ser parte del directorio digital más grande de tu ciudad.
             </p>
        </div>
        <div style="background:white; width:100%; color:black; text-align:center;">
            <p>
            Da click
<a href="https://www.mrkados.com/validacionCuenta.php?correo={{correo}}&type=2" style="font-weight:bold;">AQUÍ</a>
            para validar tu cuenta MrKliente.
            </p>
