...
Page::topMenu_fen($user, $usuarioTipo, $estado, $ciudad, $colonia, $filtroEnv);
Page::negocios_result_fen($estado, $colonia, $ciudad, $conection, $user, $usuarioTipo, $filtroEnv, $orden);
