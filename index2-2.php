...
Page::slide_banner_index($conection); //Banner que contiene el bloque del slide principal
Page::categorias_banner_index($user, $usuarioTipo, $conection); //Banner de categorias
Page::tiendas_paquetes_basicos($user,$usuarioTipo); // Banner qu contiene los paquetes basicos
Page::pasos_banner_index(); // Banner que contiene los 3 pasos a seguir
